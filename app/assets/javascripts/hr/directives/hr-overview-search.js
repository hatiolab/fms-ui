...
.controller('hrOverviewSearchCtrl', function($rootScope, $scope, $element, $filter, GridUtils, FmsUtils, RestApi, ConstantReport) {
	/**
	 * 차트 바인딩 데이터 
	 */
	$scope.items = [ {
		chartId : 'hr-overview-1', sort_field :'drive_time', labels :[], data : [], filter : 'fmsworktime'
	}, {
