angular.module('fmsMonitor').directive('monitorSideInfo', function() { 
	return { 
		restrict: 'E',
		controller: 'monitorSideInfoCtrl',
		templateUrl: '/assets/monitor/views/sidebar/monitor-side-info.html',
		scope: {}
	}; 
})
.controller('monitorSideInfoCtrl', function($rootScope, $scope, $resource, $element, GridUtils, RestApi) {
