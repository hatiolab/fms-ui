...
.controller('reportsOverviewSearchCtrl', function($rootScope, $scope, $element, $timeout, FmsUtils, RestApi) {
	/**
	 * 차트 바인딩 데이터 
	 */
	$scope.items = [ {
		...
		chartId : 'report-overview-2', sort_field :'drive_dist', labels : [], data : []
	}, {
