# This migration comes from trkvue_engine (originally 20150812044116)
class CreateFleetSummaries < ActiveRecord::Migration
	...
	def change
		...
		add_index :fleet_summaries, [:domain_id,:fleet_id,:sum_day], :unique => true, :name => :ix_fleet_sum_0
